...
export function getStats() {
  ...
  return { todayJobs: todayJobs.length, activeJobs: activeJobs.length, readyJobs: readyJobs.length, todayIncome, weekIncome, totalJobs: jobs.length }
}
